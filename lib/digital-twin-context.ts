...
- Clinical Emergencies: healthcare support website focused on clarity, urgency, and accessible service information. Enquiries are captured into Zoho CRM as structured leads via a custom Zoho CRM API integration — custom lead fields built in Zoho, with the OAuth token flow set up in Postman. Live site: https://clinical-emergencies.vercel.app/
